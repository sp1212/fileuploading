...
class __TwigTemplate_adc348c773bd019cd342ed564acaee6c extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Exporting a raw query");
  ...
  ";
    ...
    {
        return new Source("", "table/export/index.twig", "/Users/niwclantstemapps/fileuploading/phpmyadmin/templates/table/export/index.twig");
    }
}
